...
{
    header("location:http://localhost:82/covido-master/dash/dashboard.php");
}
?>
<?php
...
if(isset($_POST["submit"]))
{
    ...
    $sql = "SELECT `u_id`,`username`,`role` FROM `users` WHERE `username`='$username' AND `password`='$password'";
		 ...
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign In</div>
		    <form action="" method="POST">
			 ...
			 <button type="button" name="submit" class="btn btn-light btn-block">Sign In</button>
